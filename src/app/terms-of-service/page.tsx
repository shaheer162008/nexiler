...
export const metadata: Metadata = {
    title: "Terms of Service - Virtuo Edge | Digital Agency",
    description: "Clear, transparent terms for Virtuo Edge's web development, design, and business growth services. Learn about our guarantees, payment terms, and partnership commitments.",
    openGraph: {
        title: "Terms of Service - Virtuo Edge | Digital Agency",
        description: "Clear, transparent terms for Virtuo Edge's web development, design, and business growth services. Learn about our guarantees, payment terms, and partnership commitments.",
        type: "website",
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-primary/10 to-purple-500/10 border border-primary/30 mb-8">
                        <p className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed">
                            ...
                            Whether you need a powerful website, beautiful design, or a strategy to scale your business, these terms make sure
                    ...
                    <div className="space-y-6 sm:space-y-8 text-base sm:text-lg md:text-xl text-white/80 leading-relaxed">
                        <section className="p-4 sm:p-6 md:p-8 rounded-xl bg-white/5 border border-white/10 hover:border-primary/30 transition-all">
                            ...
                            <p className="text-sm sm:text-base md:text-lg">
                                ...
                                Design, Branding, Digital Marketing, and Custom Solutions.
                            </p>
                        </section>
                        ...
                        <section className="p-6 rounded-xl bg-primary/10 border border-primary/30">
                            ...
                            <p className="mb-4">
                                ...
                                <a href="mailto:contact@virtuoedge.com" className="text-primary hover:underline">

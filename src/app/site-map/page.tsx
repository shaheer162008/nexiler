...
export const metadata: Metadata = generateMetadata({
  ...
  description: "Complete sitemap of Virtuo Edge website. Find all pages, services, portfolio, blog posts, and resources in one place. Navigate Virtuo Edge easily.",
  path: "/site-map",
  keywords: ["virtuo edge sitemap", "site navigation", "all pages", "virtuo edge pages"],
});

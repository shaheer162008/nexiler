      ...
      <section className="pt-8 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="ml-4">
                <label className="relative inline-block w-12 h-6">
                  ...
                  <span className="absolute cursor-pointer inset-0 bg-gray-200 rounded-full peer-checked:bg-black transition-colors"></span>
          ...
          <div className="flex items-center justify-center gap-4 pt-4">
            <button className="px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors font-semibold text-sm">
              Save Preferences
            </button>
            <button className="px-6 py-3 bg-white border border-gray-200 text-black rounded-lg hover:bg-gray-50 transition-colors font-semibold text-sm">
              Accept All
            </button>
          </div>
        </div>

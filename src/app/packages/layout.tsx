...
export const metadata: Metadata = {
    ...
    description: "Transparent pricing for all Virtuo Edge services. Choose from one-time project packages or monthly retainers for web development, design, branding, video editing, and more.",

...
const serviceMetadata: Record<string, { title: string; description: string; keywords: string[] }> = {
    "website-development": {
        ...
        keywords: ["virtuo edge website development", "web design", "custom website", "responsive design", "e-commerce website", "web services", "virtuo edge web services"],
    },
    "ai-automation-setup": {
        title: "Virtuo Edge Automation Setup - Business Automation Services",
        description: "Smart automation setup from Virtuo Edge to streamline operations. Improve efficiency with custom workflow automation and lead generation systems.",
        keywords: ["virtuo edge automation", "workflow automation", "business automation", "lead generation automation", "virtuo edge automation services"],
    },
    "ai-chatbot-integration": {
        title: "Virtuo Edge Chatbot Integration - 24/7 Customer Support",
        description: "Smart chatbot integration from Virtuo Edge for automated customer support and lead qualification. Multi channel deployment with natural language understanding.",
        keywords: ["virtuo edge chatbot", "chatbot integration", "automated customer support", "lead qualification", "virtuo edge chatbot services"],
    },
    "full-brand-creation": {
        title: "Virtuo Edge Brand Creation - Complete Brand Identity Services",
        ...
        keywords: ["virtuo edge brand creation", "brand identity", "logo design", "brand guidelines", "visual identity", "brand strategy"],
    },
    "motion-graphics": {
        title: "Virtuo Edge Motion Graphics - Professional Animation",
        ...
        keywords: ["virtuo edge motion graphics", "animation services", "explainer videos", "2d animation", "product animation"],
    },
    "video-editing-short": {
        title: "Virtuo Edge Short Video Editing - Reels, TikTok, Shorts",
        ...
        keywords: ["virtuo edge video editing", "reels editing", "tiktok editing", "shorts editing", "social media video", "short form content"],
    },
    "video-editing-long": {
        title: "Virtuo Edge Long Video Editing - YouTube and Podcast Editing",
        ...
        keywords: ["virtuo edge youtube editing", "podcast editing", "long form video", "video production", "content creator editing"],
    },
    "ai-automation-maintenance": {
        title: "Virtuo Edge Automation Maintenance - Ongoing Support",
        description: "Monthly automation maintenance from Virtuo Edge with 24/7 monitoring, optimization, and priority support to keep systems running at peak efficiency.",
        keywords: ["virtuo edge automation maintenance", "system monitoring", "automation optimization", "technical support"],
    },
    "seo-optimization": {
        title: "Virtuo Edge SEO Services - Rank Higher on Google",

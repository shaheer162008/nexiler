      ...
      <section className="pt-8 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-black">Complete cloud infrastructure services</p>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {providers.map((provider, index) => (
                <div key={index} className="text-center p-4 rounded-lg border border-gray-200">
                  <p className="text-sm font-semibold text-black">{provider}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="pt-8 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="p-12 rounded-2xl border border-gray-200 bg-white text-center">
            <h2 className="text-3xl font-bold text-black mb-4">Ready to Move to the Cloud?</h2>

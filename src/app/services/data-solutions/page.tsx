      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="w-16 h-16 border-2 border-gray-300 rounded-2xl flex items-center justify-center mx-auto mb-6 hover:bg-nexiler transition-all group">
            <Database className="w-8 h-8 text-black group-hover:text-white transition-colors" />
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-black max-w-2xl mx-auto leading-relaxed px-2">
            Database design, data migration, and analytics. Turn your data into actionable insights with powerful business intelligence.
          </p>
      ...
      <section className="pt-8 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-black">Comprehensive data management solutions</p>
          </div>

...
export const metadata = {
    title: "Virtuo Edge Pricing - Web Design & Development Plans",
    description: "Transparent, honest pricing from Virtuo Edge. Choose a plan for custom web development, design, branding, or maintenance. No hidden fees.",
    keywords: "virtuo edge pricing, web development pricing, design pricing, virtuo edge plans",
    openGraph: {

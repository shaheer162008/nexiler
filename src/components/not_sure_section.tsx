      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center bg-white border-2 border-gray-300 rounded-2xl p-8 sm:p-12 hover:border-nexiler hover:shadow-lg transition-all">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-nexiler-subtle border border-nexiler rounded-full mb-4">
            <div className="w-2 h-2 bg-nexiler rounded-full animate-pulse"></div>
            <span className="text-xs font-semibold text-black uppercase tracking-wider">Need Guidance?</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link 
              href="/consultation" 
              className="group relative px-6 sm:px-8 py-3.5 bg-nexiler text-black rounded-xl font-semibold text-xs sm:text-sm overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(135,237,130,0.4)] hover:-translate-y-0.5 inline-flex items-center justify-center gap-2 whitespace-nowrap"
            >
            ...
            <Link 
              href="/packages" 
              className="group relative px-6 sm:px-8 py-3.5 bg-white border-2 border-gray-300 text-black rounded-xl font-semibold text-xs sm:text-sm transition-all duration-300 hover:border-nexiler hover:shadow-lg hover:-translate-y-0.5 inline-flex items-center justify-center gap-2 whitespace-nowrap"
            >

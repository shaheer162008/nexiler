...
const testimonials = [
    ...
    {
        quote: "The Sindh Education Dashboard was critical for our government project. Virtuo Edge delivered a robust platform to track and manage education metrics across districts. It's user-friendly, secure, and handles thousands of data points without a hitch. Outstanding technical expertise.",
